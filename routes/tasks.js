...
const { getByIdVS, postTaskVS, putTaskVS, patchTaskVS, deleteTaskVS } = require("../middleware/taskValidationSchema.js")
...
router.patch('/:id', checkSchema(patchTaskVS), validate, taskController.patchTask)
